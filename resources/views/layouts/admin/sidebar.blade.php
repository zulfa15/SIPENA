            ...
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/presensi/monitoring" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M11 18h2v3h-2zm5 3v2H8v-2zm4-3H4a3.003 3.003 0 0 1-3-3V4a3.003 3.003 0 0 1 3-3h16a3.003 3.003 0 0 1 3 3v11a3.003 3.003 0 0 1-3 3M4 3a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1Z"/><path fill="currentColor" d="m16 15l-1.914-6.38L13 13l-1.309-3h-.331L10 14L8.843 9.933L8.309 11H5v-1h2.691L9 7l1.068 3.713L10.64 9h1.669l.487.973L14 4l2 8l.64-2H19v1h-1.64z"/></svg>
                </span>
                  <span class="nav-link-title">
                    Monitoring Presensi
                  </span>
              ...
              <li class="nav-item">
                <a class="nav-link" href="/presensi/izinsakit" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M3 8h18V4H3zm0 6h18v-4H3zm0 6h18v-4H3zM4 7V5h2v2zm0 6v-2h2v2zm0 6v-2h2v2z"/></svg>
                </span>
                  <span class="nav-link-title">
                    Data Izin/Sakit
                  </span>
              ...
              <li class="nav-item">
                <a class="nav-link" href="/presensi/dinasluar" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M20.5 2h-5a.27.27 0 0 1-.21-.12a3.82 3.82 0 0 0-6.58 0A.27.27 0 0 1 8.5 2h-5A1.5 1.5 0 0 0 2 3.5v19A1.5 1.5 0 0 0 3.5 24h17a1.5 1.5 0 0 0 1.5-1.5v-19A1.5 1.5 0 0 0 20.5 2M19 16.26a2.5 2.5 0 0 1-.6 1.63l-1.92 2.24a2.52 2.52 0 0 1-1.9.87H5.5a.5.5 0 0 1-.5-.5v-15a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 .5.5Z"/><path fill="currentColor" d="m14.75 8.66l-3.89 5.18a.24.24 0 0 1-.37 0l-1.82-1.79a1.25 1.25 0 0 0-1.77 1.77L9.07 16a2.32 2.32 0 0 0 3.5-.25l4.18-5.57a1.25 1.25 0 0 0-2-1.5Z"/></svg>
                  </span>
                  <span class="nav-link-title">
                    Pengajuan Dinas
                  </span>
